...
export class ActorsClient {
    ...
    get(skip: number | undefined, take: number | undefined, name: string | null | undefined, surname: string | null | undefined): Promise<ActorsModel> {
    ...
    protected processGet(response: Response): Promise<ActorsModel> {
        ...
        if (status === 200) {
            ...
            result200 = ActorsModel.fromJS(resultData200);
            return result200;
            });
        ...
        return Promise.resolve<ActorsModel>(<any>null);
    }

    getLookups(): Promise<ActorLookupModel> {
    ...
    protected processGetLookups(response: Response): Promise<ActorLookupModel> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = ActorLookupModel.fromJS(resultData200);
            return result200;
            });
        } else if (status !== 200 && status !== 204) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<ActorLookupModel>(<any>null);
    }
}
...
export class DirectorsClient {
    ...
    getLookups(): Promise<DirectorLookupModel> {
    ...
    protected processGetLookups(response: Response): Promise<DirectorLookupModel> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = DirectorLookupModel.fromJS(resultData200);
            return result200;
            });
        } else if (status !== 200 && status !== 204) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<DirectorLookupModel>(<any>null);
    }
}
...
export class MoviesClient {
    ...
    get(id: string | undefined): Promise<MovieModel> {
    ...
    protected processGet(response: Response): Promise<MovieModel> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = MovieModel.fromJS(resultData200);
            return result200;
            });
        } else if (status !== 200 && status !== 204) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<MovieModel>(<any>null);
    }
    ...
    getAll(skip: number | undefined, take: number | undefined, title: string | null | undefined, year: number | null | undefined, locations: Location[] | null | undefined, directorIds: string[] | null | undefined, actorIds: string[] | null | undefined): Promise<AllMoviesViewModel> {
    ...
    protected processGetAll(response: Response): Promise<AllMoviesViewModel> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = AllMoviesViewModel.fromJS(resultData200);
            return result200;
            });
        } else if (status !== 200 && status !== 204) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<AllMoviesViewModel>(<any>null);
    }
...
export class ActorsModel implements IActorsModel {
    actors?: ActorsDto[] | undefined;
    total!: number;

    constructor(data?: IActorsModel) {
        if (data) {
    ...
    static fromJS(data: any): ActorsModel {
        data = typeof data === 'object' ? data : {};
        let result = new ActorsModel();
        result.init(data);
        return result;
    }
...
export class ActorLookupModel implements IActorLookupModel {
    actorLookups?: ActorLookupDto[] | undefined;

    constructor(data?: IActorLookupModel) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): ActorLookupModel {
        data = typeof data === 'object' ? data : {};
        let result = new ActorLookupModel();
        result.init(data);
        return result;
    }
...
export interface IActorLookupModel {
    actorLookups?: ActorLookupDto[] | undefined;
}
...
export class DirectorLookupModel implements IDirectorLookupModel {
    directorLookups?: DirectorLookupDto[] | undefined;

    constructor(data?: IDirectorLookupModel) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): DirectorLookupModel {
        data = typeof data === 'object' ? data : {};
        let result = new DirectorLookupModel();
        result.init(data);
        return result;
    }
...
export interface IDirectorLookupModel {
    directorLookups?: DirectorLookupDto[] | undefined;
}
...
export class AllMoviesViewModel implements IAllMoviesViewModel {
    movies?: MoviesDto[] | undefined;
    actorLookups?: ActorLookupDto[] | undefined;
    directorLookups?: DirectorLookupDto[] | undefined;
    total!: number;

    constructor(data?: IAllMoviesViewModel) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): AllMoviesViewModel {
        data = typeof data === 'object' ? data : {};
        let result = new AllMoviesViewModel();
        result.init(data);
        return result;
    }
...
export interface IAllMoviesViewModel {
    movies?: MoviesDto[] | undefined;
    actorLookups?: ActorLookupDto[] | undefined;
    directorLookups?: DirectorLookupDto[] | undefined;
    total: number;
